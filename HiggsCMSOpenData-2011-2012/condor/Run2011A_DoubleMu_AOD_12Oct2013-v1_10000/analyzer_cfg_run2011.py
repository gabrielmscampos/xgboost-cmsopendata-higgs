...
#goodJSON = '/afs/cern.ch/user/g/gamoreir/public/CMSSW_5_3_32/src/HiggsExample20112012/datasets/Cert_160404-180252_7TeV_ReRecoNov08_Collisions11_JSON.txt'
...
#files = FileUtils.loadListFromFile(file) #FileUtils.loadListFromFile('../datasets/2011_lists/' + file)
file = sys.argv[2]
